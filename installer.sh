...
PORT=$SERVER_PORT
IP=$SERVER_IP 
echo "Чтобы начать использовать скрипт, создайте файл "key.txt" в директории с сервером и впишите в него ключ. Чтобы получить ключ напишите Niksss#5489"
KEYS=$(<./key.txt)
...
then
    ...
    echo "Ключ введён не правильно , или вам выдан бан! Чтобы получить ключ, создайте файл key.txt , и в него напишите ключ. Чтобы получить ключ напишите админу"
exit
if [ "$result" == "banned" ]
then
