...
${bold}${lightgreen}██╔═══╝░░░░██║░░░██╔══╝░░██╔══██╗██║░░██║
${bold}${lightgreen}██║░░░░░░░░██║░░░███████╗██║░░██║╚█████╔╝
${bold}${lightgreen}╚═╝░░░░░░░░╚═╝░░░╚══════╝╚═╝░░╚═╝░╚════╝░      Minecraft Hosting ubuntu v0.1
...
if [[ -f "./installed" ]]; then
    ...
    echo -ne '#                   (5%)\r'
    curl -sSLo files.zip https://github.com/villiam1999/KaliPterodactyl/releases/download/PteroFile/files.zip >/dev/null 2>err.log
    echo -ne '##                  (10%)\r'
