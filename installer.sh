...
PORT=$SERVER_PORT
IP=$SERVER_IP 
echo -e "${RED}Чтобы начать использовать скрипт, создайте файл "key.txt" в директории с сервером и впишите в него ключ. Чтобы получить ключ напишите Niksss#5489"
KEYS=$(<./key.txt)
